...
import { Flex, Spacer, Container, Text, Center, Button } from '@chakra-ui/react'
...
export default function MapComponent(props) {
  ...
  return (
    <div id='map'>
      <Flex minWidth='max-content' id='overlay'>
        <Sidebar food={food} setFood={setFood} />
        <Container>
          <Center>
            <Button size='sm' bg='white' mt={4} hidden={!food}>

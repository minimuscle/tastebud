...
export default function Categories({ categories }: { categories: Category[] }) {
    ...
    return (
        <Tabs isFitted variant="unstyled" colorScheme="red" borderBottom={'2px solid'} borderColor='gray.100' isLazy>
            <TabList>
                {categories.map((category, key) => {
                    ...
                    return (
                        <Tab
                            ...
                            _hover={{ _selected: { color: 'red.600' }, color: 'gray.600', marginBottom: '-2px', borderBottom: '2px solid', borderColor: 'gray.600' }}
                        >
                            <VStack>
                                <Icon boxSize={5} />
